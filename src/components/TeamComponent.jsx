                ...
                <div className="row">
                    <div className="col-md-12">
                        <div className="section_heading">
                            <h2> Team Members </h2>
                            <h4>
                                We&apos;re the best international team, keeping
                                connected and communicated to make things
                                happen!{' '}
                            </h4>
                        </div>
                    </div>
                ...
                >
                    <div className="card">
                        <div className="member_img">
                            <img src={Nathalie} alt="Nathalie Haußmann" />
                        </div>
                    ...
                    <div className="card">
                        <div className="member_img">
                            <img src={Marko} alt="Marko Shiva Pavlovic" />
                        </div>
                        <div className="member_name">
                    ...
                    <div className="card">
                        <div className="member_img">
                            <img src={Nastja} alt="Nastja Gatsenko" />
                        </div>
                        <div className="member_name">
                    ...
                    <div className="card">
                        <div className="member_img">
                            <img src={Misrah} alt="Misrah Mohamed" />
                        </div>
                        <div className="member_name">
                    ...
                    <div className="card">
                        <div className="member_img">
                            <img src={Isabel} alt="Isabel Arens" />
                        </div>
                        <div className="member_name">
                            <h5> Isabel Arens </h5>
                        </div>
                    ...
                    <div className="card">
                        <div className="member_img">
                            <img src={Paula} alt="Paula Rodriguez" />
                        </div>
                        <div className="member_name">
                    ...
                    <div className="card">
                        <div className="member_img">
                            <img src={Olha} alt="Olha Onofriichuk" />
                        </div>
                        <div className="member_name">
                    ...
                    <div className="card">
                        <div className="member_img">
                            <img src={Vanessa} alt="Vanessa Guillen" />
                        </div>
                        <div className="member_name">
